...
3. The race starts automatically.
4. Watch the turtles race!
5. Result will appear in the console:

   * 🎉 You won (if your turtle wins)
   * 😢 You lose (if another turtle wins)
...
* Place turtles at different Y positions
* Start race when user enters a bet
